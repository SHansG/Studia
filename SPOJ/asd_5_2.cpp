...
{
public:
void GetIndexesOfColumnsToSort(vector<int> &indexesOfColumnsToSort,int &numberOfColumnsToSort)
{
...
void fillMatrix(vector<vector<double>>& matrix, int& columns)
{
    int counter = 0;
	double number;
	vector<double> row;
...
int main()
{
	...
	s.GetIndexesOfColumnsToSort(indexesOfColumnsToSort,numberOfColumnsToSort);
	s.fillMatrix(matrix, columns);
	//sortowanie
	for (int i = 0; i < numberOfColumnsToSort; i++)
	{
		s.sortColumns(matrix, indexesOfColumnsToSort);
